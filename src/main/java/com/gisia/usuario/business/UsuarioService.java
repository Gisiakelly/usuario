...
import com.gisia.usuario.infrastructure.entity.Endereco;
import com.gisia.usuario.infrastructure.entity.Telefone;
...
import com.gisia.usuario.infrastructure.repository.EnderecoRepository;
import com.gisia.usuario.infrastructure.repository.TelefoneRepository;
...
public class UsuarioService {
    ...
    public String autenticarUsuario(UsuarioDTO usuarioDTO) {
        try {
            ...
            throw new UnauthorizedExeception("Usuário ou senha inválidos:", e.getCause());
        }
    ...
    public void emailExiste(String email) {
        try {
            ...
            throw new ConflictException("Email já cadastado", e.getCause());
        }
    }
    ...
    public UsuarioDTO atualizaDadosUsuario(String token, UsuarioDTO dto){
        //Aqui buscamos o email do usuario através do token(tirar a obrigatoridade do email)
        String email = jwtUtil.extrairEmailToken(token.substring(7));

        //Criptografia de senha
        dto.setSenha(dto.getSenha() != null ? passwordEncoder.encode(dto.getSenha()) : null);

        //Busca os dados do usuário de dados
        Usuario usuarioEntity = usuarioRepository.findByEmail(email).orElseThrow(() ->
                new ResourceNotFoundException("Email não localizado"));

        //Mesclou os dados que recebemos na riquisição DTO com os dados do banco de dados
